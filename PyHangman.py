...
img0=PhotoImage(file="img/wizard3.png")
img1=PhotoImage(file="img/HangmanWord.png")
img2=PhotoImage(file="img/HangmanWord6.png")
img3=PhotoImage(file="img/HangmanWord5.png")
img4=PhotoImage(file="img/HangmanWord4.png")
img5=PhotoImage(file="img/HangmanWord3.png")
img6=PhotoImage(file="img/HangmanWord2.png")
img7=PhotoImage(file="img/HangmanWord1.png")
